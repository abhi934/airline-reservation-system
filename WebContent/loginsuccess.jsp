      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto" >
           <form class="" action="updateindex.jsp" method="post">
            <input id="button1" type="submit" name="" class="btn btn-success" value="Update your Details">
           </form>     
          <form class="" action="deleteindex.html" method="post">
            <input id="button1" type="submit" name="" class="btn btn-secondary" value="View Your Ticket">
           </form>      
           <form class="" action="login.jsp" method="post">
            <input id="button1" type="submit" name="" class="btn btn-danger" value="LogOut">
           </form>      
          ...
          <div class="container">
            ...
            <div class="carousel-caption">
              <h1 class="display-2"id="title"style="color:#fff;font-size:50px;text-align:center;"><b><b>WELCOME TO AEROMEXICO</b></b></h1>
			   <form class="" action="FlightDetails.html" method="post">
			   <input id="button1" type="submit" name="" class="btn btn-light btn-lg" value="Flight Details"><br>
			   </form>
			   <p></p>
              <form class="" action="test.html" method="post">
              
                <input id="button1" type="submit" name="" class="btn btn-primary btn-lg" value="Book a Flight">
